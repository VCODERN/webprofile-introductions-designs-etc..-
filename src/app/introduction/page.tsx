  ...
  return (
    <div className="bg-gradient-to-br from-[#0D0D0D] via-[#1A1A1A] to-[#252525] overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-400 text-2xl mt-2">Cybersecurity | Developer | Designer</p>
      </motion.div>
    ...
    >
      <h2 className="text-3xl font-semibold text-white mt">Roles</h2>
    ...
    >
      <h2 className="text-white text-3xl font-semibold mb-4 text-center">Programming Languages</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        {[
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center w-24 h-24 bg-black/30 rounded-xl p-4 border border-gray-600 shadow-lg text-white text-2xl"
          >
            {lang.icon}
